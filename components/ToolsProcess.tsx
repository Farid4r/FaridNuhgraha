export default function ToolsProcess() {
  return (
    <section className="py-24 md:py-32 border-t border-border transition-colors duration-300">
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-12 about-reveal">
          ...
          <div className="w-full md:w-1/3">
            <h2 className="font-display text-4xl md:text-5xl italic font-medium tracking-tight mb-4 text-text-primary">
              Software.
            </h2>
          ...
          {/* Sisi Kanan: Daftar Tools */}
          <div className="w-full md:w-2/3 flex flex-wrap gap-4 md:justify-end">

            {/* Tag 1: Photoshop */}
            <span className="group flex items-center gap-3 px-6 py-3 md:px-8 md:py-4 border border-border rounded-md text-sm font-medium hover:border-accent hover:bg-accent hover:text-bg transition-all duration-500 cursor-default">
              <svg className="w-5 h-5 text-text-muted group-hover:text-bg transition-colors duration-500" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* Tag 3: CorelDraw */}
            <span className="group flex items-center gap-3 px-6 py-3 md:px-8 md:py-4 border border-border rounded-md text-sm font-medium hover:border-accent hover:bg-accent hover:text-bg transition-all duration-500 cursor-default">
              <svg className="w-5 h-5 text-text-muted group-hover:text-bg transition-colors duration-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
