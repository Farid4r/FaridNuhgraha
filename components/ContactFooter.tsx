    ...
    <>
      ...
      <section id="contact" className="bg-white dark:bg-dark py-32 md:py-40 transition-colors duration-300">
        <div className="container mx-auto px-6 text-center">
          ...
          <h2 className="contact-reveal text-5xl md:text-7xl font-bold tracking-tight mb-8 dark:text-white">
            Have a project in mind?<br />
            <span className="text-gray-400 italic font-normal">Let's work together.</span>
          </h2>
          
          <div className="contact-reveal flex justify-center mb-16">
            <a href="mailto:hello@farid.com" className="text-3xl md:text-5xl font-medium border-b-2 border-dark dark:border-white hover:text-primary dark:hover:text-primary hover:border-primary dark:hover:border-primary transition-colors pb-2 dark:text-white">
              hello@farid.com
            </a>
          </div>
          ...
          <div className="contact-reveal flex flex-wrap justify-center gap-8 md:gap-10 text-gray-500 dark:text-gray-400">
            {/* Instagram */}
            <a href="https://instagram.com/farid" target="_blank" rel="noreferrer" aria-label="Instagram" className="hover:text-primary dark:hover:text-primary transform hover:-translate-y-1 transition-all duration-300">
            ...
            {/* TikTok */}
            <a href="https://tiktok.com/@farid" target="_blank" rel="noreferrer" aria-label="TikTok" className="hover:text-primary dark:hover:text-primary transform hover:-translate-y-1 transition-all duration-300">
              <svg className="w-8 h-8 md:w-10 md:h-10" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* WhatsApp */}
            <a href="https://wa.me/6281234567890" target="_blank" rel="noreferrer" aria-label="WhatsApp" className="hover:text-primary dark:hover:text-primary transform hover:-translate-y-1 transition-all duration-300">
              <svg className="w-8 h-8 md:w-10 md:h-10" fill="currentColor" viewBox="0 0 24 24">
